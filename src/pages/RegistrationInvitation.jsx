// src/pages/RegistrationInvitation.jsx
  ...
  useEffect(() => {
    ...
    if (savedUserData) {
      ...
      setFormData({
        ...
        nationality: parsedData.nationality || userData.nationality,
        affiliation: parsedData.affiliation || userData.affiliation
      });
    } else {
      setFormData({
    ...
    <RegistrationPortalLayout title="INVITATION LETTER">
      ...
      <div className="bg-white shadow-md p-6 space-y-6">
            ...
            <div className="flex items-start gap-3">
                ...
                Your invitation letter will be generated based on your registration information.
                </p>
            </div>
            </div>
            ...
            {[
              {
                ...
                done: userData.profileCompleted,
                link: '/registration/portal/myinfo',
                linkLabel: 'Complete your profile'
              },
              {
                label: 'Payment completed',
                done: userData.paymentCompleted,
                link: '/registration/portal/payment',
        ...
        <div>
          ...
          <div className="space-y-5">
            ...
            <div>
              ...
              />
              <p className="text-xs text-gray-400 mt-1">Your full name as it should appear on the invitation letter</p>
            </div>
            ...
            <div>
              ...
              <div className="select-wrap">
                ...
                >
                  ...
                  {['Béninoise','Française','Canadienne','Sénégalaise','Ivoirienne','Marocaine','Tunisienne','Autre'].map(n => (
        ...
        {success && (
          <div className="fade-in flex items-center gap-2 bg-green-50 border border-green-300 rounded px-4 py-3 text-sm text-green-800">
            ...
            <span className="font-medium">Your invitation letter is being generated. The download will start shortly.</span>
          </div>
        )}
        ...
        <div>
          ...
          {!allConditionsMet && (
            <p className="text-xs text-red-500 text-center mt-2">
              Please complete your profile and payment first.
            </p>
          )}

          <p className="text-xs text-gray-400 text-center mt-2">
            The letter will be generated in PDF format and sent to your registered email address.
          </p>
        </div>
