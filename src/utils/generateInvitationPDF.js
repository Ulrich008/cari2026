...
export function generateInvitationPDF({ fullName, affiliation, nationality, passportNumber = 'N/A' }) {
  ...
  doc.addImage(LOGO_ASDS, 'PNG', pageW - mR - logoH - 2, y, logoH, logoH);
  y += logoH + 5;
  ...
  function renderMixedLine(line, lineY, segments) {
    ...
    let tokens = [{ text: remaining, bold: false }];
